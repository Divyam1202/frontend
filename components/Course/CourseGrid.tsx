...
const DEMO_COURSES = [
  ...
  },
  {
    ...
    description:
      "Master the fundamentals of data science, including statistics, Python programming, and machine learning basics.",
  ...
  },
  {
    ...
    description:
      "Comprehensive guide to digital marketing strategies, SEO, social media marketing, and analytics.",
